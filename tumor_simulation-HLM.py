...
rand.seed(2)  # Seed is chosen so that tumor doesn't go extinct 3
import matplotlib.pyplot as plt
import imageio

SAVE_DIR = '/Users/Andrew/PycharmProjects/Tumor_Simulation/output/HLM/'
...
imageio.mimsave(SAVE_DIR + 'animationHLM.gif', images, duration=5./len(images))
